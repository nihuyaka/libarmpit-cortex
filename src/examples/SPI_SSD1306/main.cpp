...
static const unsigned char F6x8_[][6] =
{
...
static void test2() 
{
	...
	g_spi = GPIO_Helper::SetupSPI1_MasterMode_PA_5_6_7(false, false, SPI_BAUD_RATE_2);
	g_rstPin = portB->GetPin(GPIO_PIN0);
	g_rstPin->SetupGPIO_OutPP(GPIO_MODE_OUT_50MHZ);
	g_dcPin = portB->GetPin(GPIO_PIN1);
	g_dcPin->SetupGPIO_OutPP(GPIO_MODE_OUT_50MHZ);
...
static void test()
{
	...
	rstPin->SetupGPIO_OutPP(GPIO_MODE_OUT_50MHZ);
	GPIO_PIN* dcPin = portB->GetPin(GPIO_PIN1);
	dcPin->SetupGPIO_OutPP(GPIO_MODE_OUT_50MHZ);
